...
Environment* Generator::generateEnvironment(int xSize, int ySize, int zSize, unsigned int seed, float targetAmountVisitable, bool silent)
{
	...
	{
		env->setCanVisitAll(true);

		if (!silent)
		{
			std::cout << amount << " / " << amount << " (100%) complete...\n";
		}
	}
